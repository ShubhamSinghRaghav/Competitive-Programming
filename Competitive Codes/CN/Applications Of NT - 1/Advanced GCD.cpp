...
and challenges to Varun to calculate gcd of two integers, 
one is a little integer and other integer has 250 digits.
...
int main(){
	...
	while(t--){
		...
		int first_mod = b[0]-'0';
		for(int i=1;i<len;i++){
			first_mod = (first_mod*10 + (b[i]-'0'))%a;
		}
		cout<<__gcd(a,first_mod)<<"\n";
	}
	return 0;
}
